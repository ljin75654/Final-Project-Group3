...
score = model.evaluate_generator(test_generator, 800)
...
visualizer = VisualizeImageMaximizeFmap(pic_shape = (113, 113, 1))
argimage = visualizer.find_images(input_img, layer_names, layer_dict, max_nfmap)
